...
module.exports = function(app) {
    ...
    app.get('/qlik-login', function (req, res) {
        ...
        if (req.user.email == "tiago.resende@vivo.com"){
            usuarioQlik = 'user04';
            console.log('#### usuario thiago',usuarioQlik);

        }else if(req.user.email == "lucio.marcato@telefonica.com"){
            usuarioQlik = 'user01';
            console.log('#### usuario lucio',usuarioQlik);
        ...
        createsession(req, res, usuarioQlik, 'QLIKSENSE');
    });

        // var usuarioQlik = '';
        // if (window.emailAutenticaçãoQlik = "tiago.resende@vivo.com"){
        //     usuarioQlik = 'user04';
        //     console.log('#### usuario thiago',usuarioQlik);
        // }else{
        //     usuarioQlik = 'user03';
